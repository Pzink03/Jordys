        ...
        <div className=" min-w-screen px-4 pt-20 flex flex-col items-center justify-center relative">
            ...
            <section className="w-full h-auto mt-[200px] ">
                <div className="flex flex-col justify-center items-center">
                        ...
                        <p className="text-center inline-block text-subtext md:w-1/2 w-5/6 ">
            ...
            <div className="mt-4 text-black w-full flex flex-col items-center justify-center">
                    ...
                    {perks.map((perk) => (
                        <div key={perk.id} className="text-center shadow-md py-10 px-2 border-2 bg-secondary-pink md:flex md:items-start md:text-left lg:block lg:text-center">
                            ...
                            <div className="mt-6 md:ml-4 md:mt-0 lg:ml-0 lg:mt-6">
                                ...
                                <p className="mt-3 text-base text-muted-foreground text-subtext">
                                {perk.description}
                                </p>
                ...
                <div className="bg-secondary-pink flex flex-col items-center py-4">
                    ...
                    <p className="md:w-1/2 w-5/6 text-center text-subtext">
